		...
		sections.forEach(function (section) { 
			...
			if (currentPos >= sectionTop && 
				...
				navbarLinks.forEach(function (navbarLink) { 
					...
					navbarLink.classList.remove('ring', 'bg-hoverColor/10', 'font-medium', 'md:bg-primaryColor/10', 'md:text-primaryColor', 'md:outline', 'md:outline-primaryColor/10');
				...
				document.querySelector('nav ul li a[href="#'
					+ sectionId + '"]') 
				.classList.add('ring', 'bg-hoverColor/10', 'font-medium', 'md:bg-primaryColor/10', 'md:text-primaryColor', 'md:outline', 'md:outline-primaryColor/10');
